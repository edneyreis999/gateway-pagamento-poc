...
export function InvoiceDetails({ invoiceId }: InvoiceDetailsProps) {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      timestamp: invoice.created_at, // In real app, this would be different
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-slate-400 font-dm-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-slate-800 border-slate-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between">
              <span className="text-slate-400 font-dm-sans">
                Data de Criação
              </span>
            ...
            <div className="pt-2 border-t border-slate-600">
              ...
              <p className="text-white mt-1 font-dm-sans">
                {invoice.description}
              </p>
            </div>
          </CardContent>
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white font-dm-sans">
                {invoice.payment_type === "credit_card"
                  ? "Cartão de Crédito"
                  : invoice.payment_type === "debit_card"
                  ? "Cartão de Débito"
                  : "PIX"}
              </span>
            </div>
        ...
        <Card className="bg-slate-800 border-slate-700">
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between">
              ...
              <span className="text-white font-mono">{invoice.account_id}</span>
            </div>
          </CardContent>
        </Card>
      </div>
